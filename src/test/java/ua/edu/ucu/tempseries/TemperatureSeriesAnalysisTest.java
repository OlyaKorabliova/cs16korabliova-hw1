...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testDeviation() {
        double[] temperatureSeries = {5.0, 8.0, 10.0, 12.0, 17.0, 20.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double expResult = 5.13;
    ...
    public void testSummaryStatistics() {
        ...
        TempSummaryStatistics expectedResult = new TempSummaryStatistics(1.0, 3.74, -5.0, 5.0);
        TempSummaryStatistics actualResult = seriesAnalysis.summaryStatistics();

        assertEquals(expectedResult.avgTemp, actualResult.avgTemp, 0.00001);
        assertEquals(expectedResult.devTemp, actualResult.devTemp, 0.00001);
        assertEquals(expectedResult.minTemp, actualResult.minTemp, 0.00001);
        assertEquals(expectedResult.maxTemp, actualResult.maxTemp, 0.00001);
